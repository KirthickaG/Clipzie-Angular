...
export class ClipService implements Resolve <Iclip | null>{
  ...
  {
    return combineLatest([this.auth.user,sort$]).pipe(   /// combining two observables
      switchMap(values =>
        {
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Iclip | Observable<Iclip> | Promise<Iclip> {
